...
var servidor="http://localhost/TP";
    ...
    if(marca != '' && patente != '' && color != '' && cochera != '' ){
        ...
        var funcionAjax=$.ajax({
            ...
            url:servidor+"/administracion/ingresarVehiculo"
                ...
                console.log("volvio de  ingresar Vehiculo" + retorno);
                cocherasLibres();
                cargarGrilla();
            },function(error){
    ...
    $(document).ready(function () {
        var funcionAjax=$.ajax({
            ...
            url:servidor+"/administracion/cocherasOcupadas",
                ...
                $('#tabla').html("<thead> <tr>   <th>Nº</th>   <th>Cochera</th>   <th>Patente</th>   <th>Marca</th>   <th>Color</th>   <th>Fecha ingreso</th> </tr></thead>");
                for (let i = 0; i < (retorno.length); i++) {
    ...
    $(document).ready(function () {
        var funcionAjax=$.ajax({
            ...
            url:servidor+"/administracion/patentesSalida",
                ...
                console.log("volvio ok con las patentes para salir");
